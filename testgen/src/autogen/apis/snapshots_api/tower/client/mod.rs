...
pub trait Snapshots: Clone + Send + Sync {
    ...
    async fn get_volume_snapshots(&self, volume_id: &uuid::Uuid) -> Result<ResponseContent<crate::models::VolumeSnapshots>, Error<crate::models::RestJsonError>>;
    ...
    async fn get_volumes_snapshots(&self, snapshot_id: Option<&uuid::Uuid>, volume_id: Option<&uuid::Uuid>) -> Result<ResponseContent<crate::models::VolumeSnapshots>, Error<crate::models::RestJsonError>>;
...
pub mod direct {
    ...
    pub trait Snapshots: Clone + Send + Sync {
        ...
        async fn get_volume_snapshots(&self, volume_id: &uuid::Uuid) -> Result<crate::models::VolumeSnapshots, super::Error<crate::models::RestJsonError>>;
        ...
        async fn get_volumes_snapshots(&self, snapshot_id: Option<&uuid::Uuid>, volume_id: Option<&uuid::Uuid>) -> Result<crate::models::VolumeSnapshots, super::Error<crate::models::RestJsonError>>;
...
impl direct::Snapshots for SnapshotsClient {
    ...
    async fn get_volume_snapshots(&self, volume_id: &uuid::Uuid) -> Result<crate::models::VolumeSnapshots, Error<crate::models::RestJsonError>> {
    ...
    async fn get_volumes_snapshots(&self, snapshot_id: Option<&uuid::Uuid>, volume_id: Option<&uuid::Uuid>) -> Result<crate::models::VolumeSnapshots, Error<crate::models::RestJsonError>> {
    
        Snapshots::get_volumes_snapshots(self, snapshot_id, volume_id).await.map(|r| r.into_body())
    }
