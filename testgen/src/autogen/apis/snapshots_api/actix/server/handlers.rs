...
async fn get_volume_snapshots<T: server::Snapshots + 'static, A: FromRequest + 'static>(_token: A, path: Path<uuid::Uuid>) -> Result<Json<crate::models::VolumeSnapshots>, RestError<crate::models::RestJsonError>> {
...
async fn get_volumes_snapshots<T: server::Snapshots + 'static, A: FromRequest + 'static>(_token: A, query: Query<get_volumes_snapshotsQueryParams>) -> Result<Json<crate::models::VolumeSnapshots>, RestError<crate::models::RestJsonError>> {
    ...
    T::get_volumes_snapshots(crate::apis::actix_server::Query(query.snapshot_id, query.volume_id)).await.map(Json)
}
