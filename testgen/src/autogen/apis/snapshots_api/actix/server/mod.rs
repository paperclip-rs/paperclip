...
pub trait Snapshots {
    ...
    async fn get_volume_snapshots(Path(volume_id): Path<uuid::Uuid>) -> Result<crate::models::VolumeSnapshots, RestError<crate::models::RestJsonError>>;
    ...
    async fn get_volumes_snapshots(Query(snapshot_id, volume_id): Query<Option<uuid::Uuid>, Option<uuid::Uuid>>) -> Result<crate::models::VolumeSnapshots, RestError<crate::models::RestJsonError>>;
