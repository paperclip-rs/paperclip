...
pub trait Volumes {
    ...
    async fn get_rebuild_history(Path(volume_id): Path<uuid::Uuid>) -> Result<serde_json::Value, RestError<crate::models::RestJsonError>>;
    ...
    async fn put_volume_property(Path(volume_id): Path<uuid::Uuid>) -> Result<crate::models::Volume, RestError<crate::models::RestJsonError>>;
    ...
    async fn put_volume_size(Path(volume_id): Path<uuid::Uuid>) -> Result<crate::models::Volume, RestError<crate::models::RestJsonError>>;
    ...
    async fn put_snapshot_volume(Path(snapshot_id, volume_id): Path<uuid::Uuid, uuid::Uuid>) -> Result<crate::models::Volume, RestError<crate::models::RestJsonError>>;
