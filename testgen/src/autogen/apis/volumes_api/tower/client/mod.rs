...
pub trait Volumes: Clone + Send + Sync {
    ...
    async fn get_rebuild_history(&self, volume_id: &uuid::Uuid) -> Result<ResponseContent<serde_json::Value>, Error<crate::models::RestJsonError>>;
    ...
    async fn put_volume_property(&self, volume_id: &uuid::Uuid) -> Result<ResponseContent<crate::models::Volume>, Error<crate::models::RestJsonError>>;
    ...
    async fn put_volume_size(&self, volume_id: &uuid::Uuid) -> Result<ResponseContent<crate::models::Volume>, Error<crate::models::RestJsonError>>;
    ...
    async fn put_snapshot_volume(&self, snapshot_id: &uuid::Uuid, volume_id: &uuid::Uuid) -> Result<ResponseContent<crate::models::Volume>, Error<crate::models::RestJsonError>>;
...
pub mod direct {
    ...
    pub trait Volumes: Clone + Send + Sync {
        ...
        async fn get_rebuild_history(&self, volume_id: &uuid::Uuid) -> Result<serde_json::Value, super::Error<crate::models::RestJsonError>>;
        ...
        async fn put_volume_property(&self, volume_id: &uuid::Uuid) -> Result<crate::models::Volume, super::Error<crate::models::RestJsonError>>;
        ...
        async fn put_volume_size(&self, volume_id: &uuid::Uuid) -> Result<crate::models::Volume, super::Error<crate::models::RestJsonError>>;
        ...
        async fn put_snapshot_volume(&self, snapshot_id: &uuid::Uuid, volume_id: &uuid::Uuid) -> Result<crate::models::Volume, super::Error<crate::models::RestJsonError>>;
...
impl direct::Volumes for VolumesClient {
    ...
    async fn get_rebuild_history(&self, volume_id: &uuid::Uuid) -> Result<serde_json::Value, Error<crate::models::RestJsonError>> {
    
        Volumes::get_rebuild_history(self, volume_id).await.map(|r| r.into_body())
    }
    ...
    async fn put_volume_property(&self, volume_id: &uuid::Uuid) -> Result<crate::models::Volume, Error<crate::models::RestJsonError>> {
    
        Volumes::put_volume_property(self, volume_id).await.map(|r| r.into_body())
    }
    ...
    async fn put_volume_size(&self, volume_id: &uuid::Uuid) -> Result<crate::models::Volume, Error<crate::models::RestJsonError>> {
    
        Volumes::put_volume_size(self, volume_id).await.map(|r| r.into_body())
    }
    ...
    async fn put_snapshot_volume(&self, snapshot_id: &uuid::Uuid, volume_id: &uuid::Uuid) -> Result<crate::models::Volume, Error<crate::models::RestJsonError>> {
    
        Volumes::put_snapshot_volume(self, snapshot_id, volume_id).await.map(|r| r.into_body())
    }
...
impl Volumes for VolumesClient {
    ...
    async fn get_rebuild_history(&self, volume_id: &uuid::Uuid) -> Result<ResponseContent<serde_json::Value>, Error<crate::models::RestJsonError>> {
        ...
        let local_var_uri_str = format!("{}/volumes/{volume_id}/rebuild-history", configuration.base_path, volume_id=volume_id.to_string());
        let mut local_var_req_builder = hyper::Request::builder().method(hyper::Method::GET);
    ...
    async fn put_volume_property(&self, volume_id: &uuid::Uuid) -> Result<ResponseContent<crate::models::Volume>, Error<crate::models::RestJsonError>> {
        ...
        let local_var_uri_str = format!("{}/volumes/{volume_id}/property", configuration.base_path, volume_id=volume_id.to_string());
        let mut local_var_req_builder = hyper::Request::builder().method(hyper::Method::PUT);
    ...
    async fn put_volume_size(&self, volume_id: &uuid::Uuid) -> Result<ResponseContent<crate::models::Volume>, Error<crate::models::RestJsonError>> {
        ...
        let local_var_uri_str = format!("{}/volumes/{volume_id}/size", configuration.base_path, volume_id=volume_id.to_string());
        let mut local_var_req_builder = hyper::Request::builder().method(hyper::Method::PUT);
    ...
    async fn put_snapshot_volume(&self, snapshot_id: &uuid::Uuid, volume_id: &uuid::Uuid) -> Result<ResponseContent<crate::models::Volume>, Error<crate::models::RestJsonError>> {
        ...
        let local_var_uri_str = format!("{}/snapshots/{snapshot_id}/volumes/{volume_id}", configuration.base_path, snapshot_id=snapshot_id.to_string(), volume_id=volume_id.to_string());
        let mut local_var_req_builder = hyper::Request::builder().method(hyper::Method::PUT);
