...
pub struct ApiClient {
    ...
    app_nodes_api: Box<dyn crate::apis::app_nodes_api::tower::client::AppNodes>,
...
pub mod direct {
    ...
    pub struct ApiClient {
        ...
        app_nodes_api: Box<dyn crate::apis::app_nodes_api::tower::client::direct::AppNodes>,
    ...
    impl ApiClient {
        pub fn new(configuration: super::Configuration) -> ApiClient {
            ...
            ApiClient {
                ...
                app_nodes_api: Box::new(crate::apis::app_nodes_api::tower::client::AppNodesClient::new(rc.clone())),
        ...
        pub fn app_nodes_api(&self) -> &dyn crate::apis::app_nodes_api::tower::client::direct::AppNodes {
            self.app_nodes_api.as_ref()
        }
...
impl ApiClient {
    ...
    pub fn app_nodes_api(&self) -> &dyn crate::apis::app_nodes_api::tower::client::AppNodes {
        self.app_nodes_api.as_ref()
    }
