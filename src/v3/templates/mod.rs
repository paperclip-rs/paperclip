...
impl ModelTemplateFile {
    /// Create a new `Self` by specifying the template path, the target prefix and file extension.
    pub(super) fn new(template: &std::path::Path, target_prefix: &str, ext: &str) -> Self {
        let gen = GenTemplateFile {
            template: template.to_path_buf(),
            target_prefix: std::path::PathBuf::from(target_prefix),
...
impl GenTemplateFile {
    ...
    pub(super) fn tpl_path(&self) -> &std::path::PathBuf {
        &self.template
    }
...
pub(super) fn default_templates() -> (
    ...
    let api_templates = vec![
        // // Actix
        ApiTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/actix/client/api_clients.mustache"),
            "apis",
            "actix/client/mod.rs",
        ),
        ApiTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/actix/server/handlers.mustache"),
            "apis",
            "actix/server/handlers.rs",
        ),
        ApiTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/actix/mod.mustache"),
            "apis",
            "actix/mod.rs",
        ),
        ApiTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/actix/server/api.mustache"),
            "apis",
            "actix/server/mod.rs",
        ),
        // // Tower-hyper
        ApiTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/tower-hyper/mod.mustache"),
            "apis",
            "tower/mod.rs",
        ),
        ApiTemplateFile::new(
            std::path::Path::new(
                "./src/v3/templates/default/tower-hyper/client/api_clients.mustache",
            ),
            "apis",
            "tower/client/mod.rs",
        ),
        // // Common
        ApiTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/mod.mustache"),
            "apis",
            "mod.rs",
        ),
        ApiTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/api_doc.mustache"),
            "docs/apis",
            ".md",
        )
    ...
    let model_templates = vec![
        ModelTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/model.mustache"),
            "models",
            ".rs",
        ),
        ModelTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/model_doc.mustache"),
            "docs/models",
            ".md",
        )
    ...
    let supporting_templates = vec![
        SuppTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/model_mod.mustache"),
            "models",
            "mod.rs",
        ),
        SuppTemplateFile::new(
            std::path::Path::new(
                "./src/v3/templates/default/tower-hyper/client/configuration.mustache",
            ),
            "clients/tower",
            "configuration.rs",
        ),
        SuppTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/tower-hyper/client/client.mustache"),
            "clients/tower",
            "mod.rs",
        ),
        SuppTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/tower-hyper/client/body.mustache"),
            "clients/tower",
            "body.rs",
        ),
        SuppTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/api_mod.mustache"),
            "apis",
            "mod.rs",
        ),
        SuppTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/mod_clients.mustache"),
            "clients",
            "mod.rs",
        ),
        SuppTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/lib.mustache"),
            "",
            "mod.rs",
        ),
        SuppTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/actix/server/api_mod.mustache"),
            "apis",
            "actix_server.rs",
        ),
        SuppTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/Cargo.mustache"),
            "",
            "Cargo.toml",
        ),
        SuppTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/gitignore.mustache"),
            "",
            ".gitignore",
        ),
        SuppTemplateFile::new(
            std::path::Path::new("./src/v3/templates/default/openapi.mustache"),
            "apis",
            "openapi.yaml",
        ),
    ];
